    ...
    <div className="flex-1 overflow-y-auto p-6 max-w-4xl mx-auto w-full">
      ...
      <div className="mb-6">
        ...
        <p className="text-xs" style={{ color: 'var(--text-dim)' }}>
          Each profile maintains an isolated directory of mod archives and active states, allowing seamless switching between modpacks.
        </p>
      </div>
          ...
          return (
            <div
              ...
              style={{
                ...
                borderColor: isActive ? 'var(--copper-dim)' : 'var(--line)',
              }}
            >
              <div className="flex items-center gap-3 min-w-0 flex-1">
                <div
                  ...
                  style={{
                    background: isActive ? 'var(--good)' : 'var(--text-faint)',
                    boxShadow: isActive ? '0 0 0 3px var(--good-bg)' : 'none',
                  }}
                />
                <div className="min-w-0">
                  <div className="flex items-center gap-2">
                    ...
                    {isActive && (
                      <span className="mod-badge overhaul" style={{ fontSize: '10px' }}>
                        Active
                      </span>
                    )}
                  </div>
                  ...
                  <div className="mono text-[11px] mt-1" style={{ color: 'var(--text-faint)' }}>
                    {p.enabledCount} enabled / {p.modsCount} total mods
                  </div>
                </div>
              </div>
      ...
      {/* Export Code Modal / Box */}
      {exportModalCode && (
        <div
          className="mb-8 p-4 rounded-lg border"
          style={{ background: 'var(--panel)', borderColor: 'var(--copper-dim)' }}
        >
          <div className="flex items-center justify-between mb-2">
            <h4 className="font-semibold text-xs" style={{ color: 'var(--copper)' }}>
        ...
        >
          <div>
            ...
            <div className="space-y-3">
              <div>
                <label className="block text-[11px] font-semibold mb-1" style={{ color: 'var(--text-faint)' }}>
                  Profile name
                </label>
          ...
          <div className="mt-4 pt-3 border-t flex justify-end" style={{ borderColor: 'var(--line-soft)' }}>
            <button
              type="submit"
